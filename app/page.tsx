  ...
  return (
    <main className="md:ms-[120px] md:me-[20px] w-full min-h-screen flex flex-col gap-8 items-center justify-center bg-white dark:bg-[#252525]">
      <div className="flex flex-col px-5 py-3 gap-3 items-center justify-center">
        <p className="text-center">Hello 👋🏻, I&apos;m Naufal Abdussyakur and you can call me Alen. I&apos;m a</p>
        <h1 className="text-center font-bold text-5xl">UI/UX Designer<br />Based in Indonesia</h1>
