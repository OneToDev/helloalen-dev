...
export const Footer = () => {
  return (
    <div className="flex justify-between bg-transparent px-4 md:px-12 lg:px-96 py-6 pt-24">
      ...
      <div className="flex flex-row gap-3 text-white dark:hidden">
        <Link href="/"><Image src={Instagram} alt="Instagram" width={26}/></Link>
        <Link href="/"><Image src={LinkedIn} alt="LinkedIn" width={26}/></Link>
        <Link href="/"><Image src={Telegram} alt="Telegram" width={26}/></Link>
        <Link href="/"><Image src={Github} alt="Github" width={26}/></Link>
      </div>
      <div className="hidden dark:flex flex-row gap-3 text-white">
        <Link href="/"><Image src={InstagramDark} alt="Instagram" width={26}/></Link>
        <Link href="/"><Image src={LinkedInDark} alt="LinkedIn" width={26}/></Link>
        <Link href="/"><Image src={TelegramDark} alt="Telegram" width={26}/></Link>
        <Link href="/"><Image src={GithubDark} alt="Github" width={26}/></Link>
      </div>
    </div>
  );
};
