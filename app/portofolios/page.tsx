...
export default function page() {
  return (
    <main className="md:ms-[120px] w-full min-h-screen flex flex-col gap-20 bg-white dark:bg-maBlack py-40 md:pt-32">
      ...
      <div className="flex gap-5 px-8">
        <Link href='/portofolios/Bragada.ui'>
          <div className="card card-compact w-full md:w-96 bg-base-100 shadow-xl hover:scale-105 transition-all duration-300 hover:shadow-md rounded-xl overflow-hidden">
            <figure>
              <Image src={Thumbnail} alt='Thumbnail' />
            </figure>
            <div className="card-body p-3">
              <h2 className="card-title text-3xl font-bold text-maOrange">Bragada.ui</h2>
              <p className='text-maDarkGray dark:text-maGray'>Designed by <span className='italic font-medium text-maBlack dark:text-white'>Helloalen.dev</span></p>
            </div>
          </div>
        </Link>
      </div>
